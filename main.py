# 1. Write a Python program which accepts the users first and last name and print them in reverse 
...
def currentDateAndTime (time):
  dateAndTime = str(time)
  return 'current date and time is: ' + dateAndTime
  
print(currentDateAndTime(time))
...
# 4. Write a Python program to print the following string in a specific format (see the output). 
...
# 9. Write a Python function to sum all the numbers in a list. Go to the editor
# Sample List : (8, 2, 3, 0, 7)
# Expected Output : 20 

# 10. Write a Python program which iterates the integers from 1 to 50. For multiples of three print "Fizz" 
